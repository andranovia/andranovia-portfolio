    ...
    <div>
      <div className=" h-80 w-80 lg:w-full lg:h-96  dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative rounded-xl mt-10 lg:mt-0 ">
        ...
        <motion.div className="relative h-full w-full flex flex-col">
          ...
          >
            <h1 className="text-2xl lg:text-5xl absolute text-center -mt-40 text-white font-bold w-full">
              Modern influence
            </h1>
            <motion.div
              animate={controls}
              ...
              className="max-w-3xl  relative top-20 lg:h-[18rem] w-[17rem] border-4 border-[#6C6C6C] p-2 bg-[#222222] rounded-[30px] shadow-2xl"
            >
              {" "}
