...
function Hero() {
  ...
  return (
    <div className={bebasNeue.className}> 
      <div className="bg-primary overflow-hidden  lg:overflow-visible  lg:mt-0  rounded-xl relative flex justify-start bg-dot-white/[0.3] lg:justify-center  items-center    lg:pt-[4rem] font-bold  ">
      <div className="bg-primary hidden absolute pointer-events-none inset-0 z-10 lg:flex items-center justify-center rounded-xl   [mask-image:radial-gradient(ellipse_at_center,transparent_70%,black)]"></div>
        <HeroText/>
        <div className="absolute pointer-events-none -bottom-[14%] -right-[10%]  lg:-bottom-[30%] md:-right-[4%] lg:-right-[10%]">
